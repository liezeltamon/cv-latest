        ...
        {Postdoctoral computational biologist}{University of Oxford, UK}{Full-time research}{Dec. 2024 -- present}
            \resumeItemListStart
                \resumeItem{Multi-omic bulk and single-cell research} {Integrating bulk and single-cell data to analyse gene and protein expression (CITE-seq, CyTOF) and adaptive immune repertoire to understand the mechanisms of Systemic Lupus Erythematosus (SLE) progression - Supervised by \href{https://www.bioch.ox.ac.uk/research/bashford-rogers}{Assoc. Prof. Rachael Bashford-Rogers - From adaptive immunity to clinical translation}}
                    \begin{itemize}
                        \resumeItem {Workflows using both R and Python}{Seurat, Bioconductor, scanpy, scvi, etc.}
                    \end{itemize}
            \resumeItemListEnd
